...
var BunsList = () => {
  const [recipes, setRecipes] = import_react.useState([]);
  ...
  return jsx_dev_runtime.jsxDEV("div", {
    children: recipes.map((recipe) => {
      recipe.name, recipe.imgSrc, recipe.name, recipe.slug;
    })
...
client.default.createRoot(document.getElementById("root")).render(jsx_dev_runtime2.jsxDEV(import_react2.default.StrictMode, {
  children: jsx_dev_runtime2.jsxDEV(BunsList, {}, undefined, false, undefined, this)
}, undefined, false, undefined, this));
